...
sub new {
	...
	$self->{m_staticText41} = Wx::StaticText->new(
		$self,
		-1,
		"Sprecher:",
	);
	...
	$bSizer5->Add( $self->{btn_cancel}, 0, wxALL, 5 );

	my $fgSizer1 = Wx::FlexGridSizer->new( 0, 2, 5, 20 );
	$fgSizer1->SetFlexibleDirection(wxBOTH);
	$fgSizer1->SetNonFlexibleGrowMode(wxFLEX_GROWMODE_SPECIFIED);
	$fgSizer1->Add( $self->{m_staticText2}, 0, wxTOP | wxRIGHT, 10 );
	$fgSizer1->Add( $self->{m_staticText4}, 0, wxTOP, 10 );
	$fgSizer1->Add( $self->{dat_date}, 0, wxRIGHT, 5 );
	$fgSizer1->Add( $self->{txt_situation}, 0, wxRIGHT, 5 );
	...
	$siz_data->Add( $fgSizer1, 1, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 20 );
	...
	$sbSizer3->Add( $self->{m_staticText5}, 0, wxALL, 20 );

	my $bSizer71 = Wx::BoxSizer->new(wxVERTICAL);
	$bSizer71->Add( $sbSizer3, 1, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 20 );

	my $bSizer6 = Wx::BoxSizer->new(wxHORIZONTAL);
	$bSizer6->Add( $self->{m_staticText41}, 0, 0, 10 );
	$bSizer6->Add( $self->{rad_spkr_child}, 0, wxRIGHT | wxLEFT, 10 );
	$bSizer6->Add( $self->{rad_spkr_other}, 0, wxRIGHT | wxLEFT, 10 );
	$bSizer6->Add( $self->{rad_spkr_comment}, 0, wxLEFT, 10 );

	my $bSizer51 = Wx::BoxSizer->new(wxHORIZONTAL);
	$bSizer51->Add( $self->{txt_utterance}, 1, 0, 10 );
	$bSizer51->Add( $self->{btn_add_utterance}, 0, wxLEFT, 20 );
	$bSizer51->Add( $self->{btn_update_utterance}, 0, wxLEFT, 20 );
	$bSizer51->Add( $self->{btn_delete_utterance}, 0, wxLEFT, 20 );

	my $bSizer2 = Wx::BoxSizer->new(wxVERTICAL);
	$bSizer2->Add( $bSizer6, 1, wxEXPAND, 5 );
	$bSizer2->Add( $bSizer51, 1, wxEXPAND, 5 );
	...
	$siz_transcript->Add( $self->{lst_utterances}, 0, wxALL, 20 );
	$siz_transcript->Add( $bSizer2, 1, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 20 );

	my $bSizer7 = Wx::BoxSizer->new(wxHORIZONTAL);
	$bSizer7->Add( $bSizer71, 0, wxEXPAND, 5 );
	$bSizer7->Add( $siz_transcript, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 20 );

	my $siz_main = Wx::BoxSizer->new(wxVERTICAL);
	$siz_main->Add( $bSizer5, 0, wxEXPAND | wxRIGHT | wxLEFT, 20 );
	$siz_main->Add( $siz_data, 0, wxEXPAND | wxBOTTOM | wxRIGHT | wxLEFT, 20 );
	$siz_main->Add( $bSizer7, 0, wxEXPAND, 5 );

	$self->SetSizerAndFit($siz_main);
	$self->Layout;
